...
{
    this.users = [new LightDMUser("arjuna", "Arjuna-Muda", "./img/user.png", true),
				  new LightDMUser("anugrahbsoe", "anugrahbsoe", "./img/user.png", true),
				  new LightDMUser("brahmana", "Brahmana-Putra", "./img/user.png", true),];
    ...
    this.sessions = [new LightDMSession("gnome", "Gnome", "This session logs you into Gnome"),
                     ...
                     new LightDMSession("wayangde", "WayangDE", "This session logs you into WayangDE")];
    this.default_session = "wayangde";
    this.timed_login_user = "anugrahbsoe";
